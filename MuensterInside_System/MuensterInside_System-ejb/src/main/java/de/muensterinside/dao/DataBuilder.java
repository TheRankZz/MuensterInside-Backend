...
//		List<Location> locations = new ArrayList<Location>();
		...
		for(int i = 0; i < locationNamesCat1.length; i++){
			Location location = new Location(locationNamesCat1[i], locationDescriptionsCat1[i], locationLinksCat1[i], devices.get(i), categories.get(0));
			em.persist(location);
			locations.add(location);
		}
		
		for(int i = 0; i < locationNamesCat2.length; i++){
			Location location = new Location(locationNamesCat2[i], locationDescriptionsCat2[i], locationLinksCat2[i], devices.get(i), categories.get(1));
			em.persist(location);
			locations.add(location);
		}
		
		for(int i = 0; i < locationNamesCat3.length; i++){
			Location location = new Location(locationNamesCat3[i], locationDescriptionsCat3[i], locationLinksCat3[i], devices.get(i), categories.get(2));
			em.persist(location);
			locations.add(location);
		}
		
		for(int i = 0; i < locationNamesCat4.length; i++){
			Location location = new Location(locationNamesCat4[i], locationDescriptionsCat4[i], locationLinksCat4[i], devices.get(i), categories.get(3));
			em.persist(location);
			locations.add(location);
		}
