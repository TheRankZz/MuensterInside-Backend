...
public final class Messages {
	...
	public static final String NoDeleteExceptionMsg = "Konnte nicht gelöscht werden";
	public static final String NoFoundExceptionMsg = "Konnte nicht gefunden werden";
